...
const COPY = {
  ko: {
    ...
    previewShown: "이미지를 표시했습니다.",
    previewNotVisible: "이미지가 화면에 없거나 메시지 순서가 바뀌었습니다. /refresh 후 다시 선택하세요.",
    previewTerminalUnsupported: "이 터미널은 이미지 표시를 지원하지 않습니다. Ghostty, Kitty 또는 WezTerm을 사용하세요.",
    previewNoImage: "미리볼 이미지가 없습니다.",
    ...
    previewUsage: "사용법: /preview [select|latest]",
    previewSelectionKeys: "↑↓: 메시지 선택 · Enter: 미리보기 · Esc: 돌아가기",
    previewSelectImage: "사진 또는 이모티콘 메시지를 선택하세요.",
  ...
  en: {
    previewCapturing: "Capturing image…",
    previewShown: "Image shown.",
    previewNotVisible: "The image is not visible or the message order changed. Run /refresh and select it again.",
    previewTerminalUnsupported: "This terminal cannot display images. Use Ghostty, Kitty, or WezTerm.",
    previewNoImage: "No image to preview.",
    ...
    previewUsage: "Usage: /preview [select|latest]",
    previewSelectionKeys: "↑↓: select message · Enter: preview · Esc: back",
    previewSelectImage: "Select a photo or sticker message.",
